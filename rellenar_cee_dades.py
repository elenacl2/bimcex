...
def generar_excel_datos_cee(ruta_xml):
    ...
    # Hoja 3.6 Ponts tèrmics (siempre vacía pero con encabezado)
    ...
    hoja_util_creada = True  # Consideramos esta hoja como válida aunque esté vacía

    # Eliminar la hoja por defecto si al menos una hoja útil fue creada
    if hoja_util_creada:
